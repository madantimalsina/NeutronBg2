...
void CountMSSS::Execute() {
 ...
 /* //ROI
  ...
  //FV
  //if (IsNeutron_PTFE == true or IsNeutron_neutron == true or IsNeutron_USF == true && m_cuts->mdc3()->Fiducial() && ETrain == false)
  //  { m_hists->BookFillHist("PEn_FV", 100, 0., 10000., (*m_event->m_TruthEvent)->parentEnergy_keV); }
  // Skin
  if (IsNeutron_PTFE == true or IsNeutron_neutron == true or IsNeutron_USF == true && ETrain == false && !m_cuts->mdc3()->SkinVeto())
  { m_hists->BookFillHist("PEn_Skin", 100, 0., 10000., (*m_event->m_TruthEvent)->parentEnergy_keV); }
  // OD
 if (IsNeutron_PTFE == true or IsNeutron_neutron == true or IsNeutron_USF == true && ETrain == false && !m_cuts->mdc3()->ODVeto())
  { m_hists->BookFillHist("PEn_OD", 100, 0., 10000., (*m_event->m_TruthEvent)->parentEnergy_keV); }
  // Skin and OD
  if (IsNeutron_PTFE == true or IsNeutron_neutron == true or IsNeutron_USF == true && ETrain == false && !m_cuts->mdc3()->SkinVeto() && !m_cuts->mdc3()->ODVeto())
...
*/
  ...
  if ((*m_event->m_TruthEvent)->parentParticle == "PTFEAlphaN_neutron_Ulate_n0" or
      ...
      (*m_event->m_TruthEvent)->parentParticle == "PTFEAlphaN_neutron_Th_n4" or
      (*m_event->m_TruthEvent)->parentParticle == "PTFEAlphaN_neutron_Th_n5" or
      (*m_event->m_TruthEvent)->parentParticle == "PTFEAlphaN_neutron_Th_n6" && ETrain == false) 
